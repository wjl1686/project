 ...
 * 返回数据
 */
public class AjaxObject extends LinkedHashMap<String, Object> {
	...
	public static AjaxObject getAjaxStatus(Dict.AjaxStatus ajaxStatus) {
		return error(ajaxStatus.getStatusCode(), ajaxStatus.getStatusName());
	}
